...
The 7th Workshop on Gender Bias in Natural Language Processing (GeBNLP 2026) will be co-located with the [**5th AACL**](https://2026.aaclnet.org/) in **Hengqin, China**. The workshop will be held **fully remotely**.
...
- **Measurement and Evaluation**: New metrics and datasets for quantifying bias in LLMs, machine translation, and multimodal systems.
